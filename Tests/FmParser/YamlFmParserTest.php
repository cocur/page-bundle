...
use Cocur\Bundle\BlogBundle\FmParser\YamlFmParser;
...
class YamlFmParserTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @test
     *
     * @covers Cocur\Bundle\BlogBundle\FmParser\YamlFmParser::parse()
     */
     ...
     * @test
     *
     * @covers Cocur\Bundle\BlogBundle\FmParser\YamlFmParser::getFormat()
     */
